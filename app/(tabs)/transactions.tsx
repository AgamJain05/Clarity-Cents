    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.summaryCard}>
        <View style={styles.summaryItem}>
          ...
          <Text style={styles.summaryAmount}>-{formatCurrencySimple(thisMonthExpenses, userCurrency)}</Text>
        </View>
        <View style={styles.summaryDivider} />
        <View style={styles.summaryItem}>
          <Text style={styles.summaryLabel}>Total Income</Text>
          <Text style={[styles.summaryAmount, { color: '#00C896' }]}>+{formatCurrencySimple(thisMonthIncome, userCurrency)}</Text>
        </View>
      </View>
